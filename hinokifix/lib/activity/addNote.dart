    ...
    return Scaffold(
      ...
      body:  SingleChildScrollView(child: Column(
        ...
        children: [
            ...
            child: Row(
              ...
              children: [
                SegmentedButton(
                  ...
                  selectedIcon: SvgPicture.asset('assets/icons/galochka.svg', width: 32, height: 32, color: Colors.white,),
          ...
          SizedBox(width: double.infinity, child: Padding(padding: EdgeInsetsGeometry.only(left: 30, right: 30, top: 6), child: OutlinedButton.icon(onPressed: () {}, style: OutlinedButton.styleFrom(padding: EdgeInsets.symmetric(horizontal: 16, vertical: 10), side: BorderSide(color: Color.fromARGB(255, 190, 56, 79), width: 2)), label: Text("Прикрепить", style: GoogleFonts.jost(color: Color.fromARGB(255, 109, 109, 109), fontSize: 16),), icon: Icon(Icons.attach_file, color: Color.fromARGB(255, 109, 109, 109),),)),),
          ConstrainedBox(constraints: BoxConstraints(minHeight: 125, maxHeight: double.infinity), child: Container(),),
          SizedBox(width: double.infinity, child: Padding(padding: EdgeInsets.only(left: 30, right: 30), child: OutlinedButton(style: OutlinedButton.styleFrom(side: BorderSide(color: Color.fromARGB(255, 190, 56, 79), width: 2)), onPressed: () {}, child: Text("Hinoki!", style: GoogleFonts.jost(color: Color.fromARGB(255, 109, 109, 109), fontSize: 16),)),),)
                      ],
